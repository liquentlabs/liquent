...
impl PersistentSafetyStorage {
    ...
    fn initialize_keys_and_accounts(
        ...
        // storage.
        if let Err(laptos::aptos_secure_storage::Error::KeyAlreadyExists(_)) = result {
    ...
    pub fn default_consensus_sk(
        &self,
    ) -> Result<bls12381::PrivateKey, laptos::aptos_secure_storage::Error> {
...
mod tests {
    // use super::*;
    // use crate::counters;
    // use laptos::aptos_crypto::hash::HashValue;
    // use laptos::aptos_secure_storage::InMemoryStorage;
