...
impl From<laptos::aptos_secure_net::Error> for Error {
    #[allow(clippy::fallible_impl_from)]
    fn from(error: laptos::aptos_secure_net::Error) -> Self {
        Self::InternalError(error.to_string())
    }
}

impl From<laptos::aptos_secure_storage::Error> for Error {
    fn from(error: laptos::aptos_secure_storage::Error) -> Self {
        match error {
            laptos::aptos_secure_storage::Error::PermissionDenied => {
            ...
            laptos::aptos_secure_storage::Error::KeyVersionNotFound(_, _) |
            laptos::aptos_secure_storage::Error::KeyNotSet(_) => {
