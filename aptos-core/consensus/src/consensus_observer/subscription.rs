...
impl ConsensusObserverSubscription {
    ...
    pub fn check_subscription_peer_optimality(
        ...
        // TODO(liquent_lightman): Only need by observer
...
pub fn sort_peers_by_distance_and_latency(
    ...
    for (peer_network_id, peer_metadata) in peers_and_metadata {
        ...
        let distance = distance
            .unwrap_or(laptos::aptos_peer_monitoring_service_types::MAX_DISTANCE_FROM_VALIDATORS);
...
mod test {
    // use super::*;
    // use laptos::aptos_network::transport::ConnectionMetadata;
    // use laptos::aptos_peer_monitoring_service_types::{
    //     response::NetworkInformationResponse, PeerMonitoringMetadata,
    // };
    // use laptos::aptos_storage_interface::Result;
    // use laptos::aptos_types::transaction::Version;
    // use mockall::mock;
