...
use laptos::aptos_network::protocols::network::RpcError;
use thiserror::Error;
...
impl From<laptos::aptos_network::application::error::Error> for Error {
    fn from(error: laptos::aptos_network::application::error::Error) -> Self {
