...
use laptos::{aptos_crypto::bls12381, aptos_types::validator_signer::ValidatorSigner};
use std::sync::Arc;
...
impl CommitSignerProvider for DagCommitSigner {
    fn sign_commit_vote(
        &self,
        _ledger_info: laptos::aptos_types::ledger_info::LedgerInfoWithSignatures,
        new_ledger_info: laptos::aptos_types::ledger_info::LedgerInfo,
