...
impl NetworkPlayground {
    ...
    pub fn add_node(
        ...
        conn_mgr_reqs_rx: laptos::aptos_channels::Receiver<
            laptos::aptos_network::ConnectivityRequest,
        >,
    ) {
...
mod tests {
    ...
    fn test_network_api() {
        ...
        for (peer_id, peer) in peers.iter().enumerate() {
            ...
            let (_conn_mgr_reqs_tx, conn_mgr_reqs_rx) = laptos::aptos_channels::new_test(1024);
